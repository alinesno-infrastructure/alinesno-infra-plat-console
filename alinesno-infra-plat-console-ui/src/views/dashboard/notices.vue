...
const tableData = [
  ...
  { inde2x: 3, busType: '社交网络', projectName: '微信', content: '改进朋友圈算法，减少低质量内容展示，提高用户参与度和粘性，加强内容审核机制', level: '2' },
  { inde2x: 7, busType: '社交媒体', projectName: '抖音', content: '改进内容推荐算法，增加用户粘性，提高用户留存率，优化视频推荐和用户关注推荐', level: '2' },
]
