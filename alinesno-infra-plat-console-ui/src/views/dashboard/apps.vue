...
const solutionList = ref([
  { icon: 'https://d1by4p17n947rt.cloudfront.net/icon/051de32597041e41f73b97d61c67a13b-9cbdaf85e3bcf29b656fdedd8e6d1305.svg', name: '业务升级AIP解决方案', desc: 'With Route 53 (3 分钟)' },
  ...
  { icon: 'https://d1by4p17n947rt.cloudfront.net/icon/7177e919b32ad97825f95e902595014b-1594766d92813b5baeb706c453f91de0.svg', name: '技术AIP解决方案', desc: 'With Route 53 (3 分钟)' },
  { icon: 'fa-solid fa-ship', name: '数字化转型解决方案', desc: 'With EC2 (2 分钟)' },
