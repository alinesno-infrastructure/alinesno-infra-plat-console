            ...
            <div class="tpl-app app-main-content" v-loading="fullscreenLoading" style="max-width: 1240px;">
                ...
                <section class="section">
                    ...
                    <div class="section-body">
                        <div class="app-item border-bottom export-item" v-for="(item, i) in productList" :key="i">
                            <div class="app-item__icon wk wk-icon-user">
                                ...
                                <img :src="'http://data.linesno.com/icons/header/' + (i+2) + '.jpg'" 
                                      style="width:45px;height:45px;border-radius: 5px" />
                            </div>
                            <div class="content">
                                <h3 class="app-item__title" style="margin-top:5px;margin-bottom:5px;">
                                    {{ item.roleName }}
                                    <a class="cf-service-nav-item-label"
                                        style="margin-left:10px;margin-right:10px;float:right" :title="item.name">
...
function handleRoleChat(item) {
    roleChatUri.value = item.roleLink ; 
