  ...
  <div style="padding-top:0px;">
    ...
    <el-row :gutter="20" style="float:left;width:100%;">
      ...
      <el-col :span="12" style="border:0px;">
        <div id="echarts-bar-chart-21" :style="{ width: '100%', height: '180px' }"></div>
      </el-col>

      <el-col :span="12" style="border:0px;">
        <div id="echarts-bar-chart-23" :style="{ width: '100%', height: '180px' }"></div>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    drawBar2() {
      let barChart = echarts.init(document.getElementById('echarts-bar-chart-21'))
        var lineOption;
    ...
    drawBar() {
      let barChart = echarts.init(document.getElementById('echarts-bar-chart-23'))
      let lineOption = {
        title: {
          text: '定时任务状态'
        },
