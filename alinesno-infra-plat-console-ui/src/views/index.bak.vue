  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>若依后台管理框架</h2>
        <p>
          一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适自己的。于是利用空闲休息时间开始自己写一套后台系统。如此有了基设平台服务，她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            ...
            <el-collapse-item title="v3.3.0 - 2023-12-14">
              <ol>
                <li>新增缓存监控功能</li>
                <li>支持主题风格配置</li>
            ...
            <el-collapse-item title="v3.2.1 - 2023-11-18">
              <ol>
                <li>阻止任意文件下载漏洞</li>
                <li>代码生成支持上传控件</li>
                <li>新增图片上传组件</li>
            ...
            <el-collapse-item title="v3.2.0 - 2023-10-10">
              <ol>
            ...
            <el-collapse-item title="v3.1.0 - 2023-08-13">
              <ol>
            ...
            <el-collapse-item title="v3.0.0 - 2023-07-20">
              <ol>
                <li>单应用调整为多模块项目</li>
            ...
            <el-collapse-item title="v2.3.0 - 2023-06-01">
              <ol>
            ...
            <el-collapse-item title="v2.2.0 - 2023-03-18">
              <ol>
                <li>系统监控新增定时任务功能</li>
            ...
            <el-collapse-item title="v2.1.0 - 2023-02-24">
              <ol>
                <li>新增表单构建</li>
                <li>代码生成支持树表结构</li>
                <li>新增用户导入</li>
